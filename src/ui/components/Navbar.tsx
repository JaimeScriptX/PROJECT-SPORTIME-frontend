  ...
  return (
    <>
        <nav className="sticky top-0 z-50 lg:px-4 lg:py-4 flex justify-between items-center bg-portada">
          ...
          {
            !authenticated &&
            <Link to="/iniciar-sesion" className="hidden lg:inline-block lg:ml-auto lg:mr-4 py-2 px-6 bg-primary hover:bg-gray-100 text-md text-gray-900 font-bold rounded-xl transition duration-200 mt-4 lg:mt-0">
            Ingresar
          </Link>
          }
