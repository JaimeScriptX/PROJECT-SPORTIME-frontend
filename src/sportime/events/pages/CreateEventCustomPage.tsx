                              ...
                              <div className="mt-4">
                                  ...
                                  <div className="flex items-baseline">
                                    <input
                                        placeholder="1"
                                        type="number"
                                        className="block w-20 mr-1 px-3 py-2 mt-2 text-white bg-fondo placeholder-gray-400 border-b-2 border-gray-200  focus:border-primary focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40"
                                    />
